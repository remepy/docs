...
| `(<collection>.)items.query`  | The items query                 | `collection`, `req`                  |
| `(<collection>.)items.read`   | The read item                   | `query`, `collection`, `req`         |
| `(<collection>.)items.create` | The new item                    | `collection`, `req`                  |
| `(<collection>.)items.update` | The updated item                | `keys`, `collection`, `req`          |
| `(<collection>.)items.delete` | The keys of the item            | `collection`, `req`                  |
| `<system-collection>.create`  | The new item                    | `collection`, `req`                  |
| `<system-collection>.update`  | The updated item                | `keys`, `collection`, `req`          |
| `<system-collection>.delete`  | The keys of the item            | `collection`, `req`                  |
